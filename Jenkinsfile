pipeline{
    ...
    stages{ 
      ...
      stage("Cleanup Workspace"){
        ...
        stage("Clone Code"){
           steps{
            git url : "https://github.com/Saroj-kr-tharu/Ecommerce-fortend", branch :"main"
         } }
        ...
        stage("Trivy File System Scan") { 
            steps { 
               ...
               dir('/Agent/workspace/Marketmandu--Fortend') {
                     sh "trivy fs \
                        --format json \
           ...
           steps{
            ...
            withCredentials(  [usernamePassword(
                        ...
                        usernameVariable:"dockerHubUser" )]
                          ...
                          echo "Scanning marketmandu-fortend "
                           sh ' trivy image \
                              --format json \
                              --output trivy-report/marketmandu-fortend.json \
                              --scanners vuln \
                              ${dockerHubUser}/marketmandu-fortend:latest';
                     }
           ...
           steps{
            ...
            withCredentials(  [usernamePassword(
                        ...
                        sh '''
                          ...
                          docker push ${dockerHubUser}/marketmandu-fortend:latest
                        '''
                     }
